...
function TaskItem({ task, minutes, isExpanded, onToggle, menteeId }) {
  ...
  return (
    <li
      ...
      className={`flex flex-col rounded-xl border transition-all cursor-pointer shadow-sm active:scale-[0.99] touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-300 focus-visible:ring-offset-2 ${isTaskDone
    ...
    >
      ...
      <div
        className={`overflow-hidden transition-all duration-300 ease-in-out border-t border-dashed ${isExpanded ? "max-h-96 opacity-100 border-gray-200" : "max-h-0 opacity-0 border-transparent"
          }`}
      >
