  ...
  return (
    <div className="absolute inset-0 bg-white rounded-xl flex flex-col z-[100]">
      <div className="p-4 border-b border-gray-100 flex justify-between items-center">
        <button onClick={onCancel} className="text-gray-500 text-base border-none bg-transparent cursor-pointer">
          취소
        </button>
        <h3 className="m-0 text-base font-semibold">날짜 선택</h3>
        <button
          onClick={handleConfirm}
          className="text-blue-500 text-base font-semibold border-none bg-transparent cursor-pointer"
        >
          확인
        </button>
      </div>
        ...
        <div className="relative w-[100px] h-[160px]">
          ...
          >
            {years.map((year) => (
              <div
                key={year}
                className={`h-[40px] flex items-center justify-center snap-center cursor-pointer transition-all ${
    ...
    >
      ...
      >
        ...
        <div className="px-4 pb-0 overflow-visible">
          <CalendarWeekHeader />
          <div className="grid grid-cols-7 w-full border-l border-t border-gray-200">
            {days.map((day) => {
