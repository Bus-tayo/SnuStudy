...
export function CalendarRoot({ tasks, events, title, onDateClick, height }) {
  return (
    <CalendarProvider tasks={tasks} events={events} title={title} onDateClick={onDateClick} height={height}>
